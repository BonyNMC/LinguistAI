...
const TABS = [
  { key: 'words_mastered',     label: '🏆 Most Mastered',   desc: 'Words fully mastered' },
          ...
          {sorted.map((row, idx) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)', minWidth: 0 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                    <div style={{
                      ...
                      color: isMe ? 'var(--clr-accent-light)' : 'var(--clr-text-primary)',
                      fontSize: 'var(--font-size-sm)',
                ...
                {/* Mastered words */}
                <div style={{
                  textAlign: 'right', fontWeight: tab === 'words_mastered' ? 800 : 400,
                  color: tab === 'words_mastered' ? 'var(--clr-accent-light)' : 'var(--clr-text-secondary)',
                  fontSize: 'var(--font-size-sm)',
                }}>
                  {row.words_mastered}
                </div>
                ...
                {/* Activity count */}
                <div style={{
                  textAlign: 'right', fontWeight: tab === 'total_activity_count' ? 800 : 400,
                  color: tab === 'total_activity_count' ? 'var(--clr-accent-light)' : 'var(--clr-text-secondary)',
                  fontSize: 'var(--font-size-sm)',
                }}>
                ...
                {/* Mastery score */}
                <div style={{
                  textAlign: 'right', fontWeight: tab === 'total_mastery_points' ? 800 : 400,
                  color: tab === 'total_mastery_points' ? 'var(--clr-accent-light)' : 'var(--clr-text-secondary)',
                  fontSize: 'var(--font-size-sm)',
                }}>
                  {row.total_mastery_points}
                </div>
              </div>
            )
          })}
